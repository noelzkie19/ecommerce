...
export const Footer = () => (
  <footer className="bg-gray-950 text-gray-400">
    ...
    <div className="w-full max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 pt-12 pb-8">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12 pb-10 border-b border-gray-800">
        {/* ── Brand ── */}
        <div className="col-span-2 md:col-span-1">
          ...
          <p className="text-gray-400 text-sm leading-relaxed max-w-[220px] mb-5">
