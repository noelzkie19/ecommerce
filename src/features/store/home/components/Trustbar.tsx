      ...
      <div className="grid grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6">
        {TRUST_ITEMS.map(({ icon, label }) => (
          <div key={label} className="flex flex-col items-center gap-2.5 group">
            <div className="w-14 h-14 sm:w-16 sm:h-16 bg-white rounded-full border border-orange-100 flex items-center justify-center text-orange-600 shadow-sm group-hover:shadow-md group-hover:border-purple-300 group-hover:scale-105 transition-all duration-300">
              {icon}
            </div>
