  ...
  return (
    <div className="flex items-center justify-center gap-2 mt-10">
      <button
        ...
        disabled={page <= 1}
        className="px-4 py-2 text-sm font-semibold text-gray-600 bg-white border border-gray-200 rounded-xl hover:border-purple-300 hover:text-purple-600 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
      >
        Previous
      </button>
