...
import type { TestimonialMeta } from "@/types/testimonial.types";

interface Props {
  readonly meta: TestimonialMeta;
  readonly onPageChange: (page: number) => void;
}

export default function TestimonialsPagination({ meta, onPageChange }: Props) {
