  ...
  <>
    ...
    <div className="p-5 border-b border-white/10">
      <div className="flex items-center gap-3">
        <div className="w-9 h-9 bg-purple-600 rounded-xl flex items-center justify-center text-sm font-bold shrink-0">
          {initial}
        </div>
        <div>
          ...
          <p className="text-purple-400 text-xs">Affiliate Portal</p>
        </div>
      </div>
    </div>
    ...
    <div className="p-4 border-t border-white/10 space-y-3">
      {user && (
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-purple-700 rounded-full flex items-center justify-center text-sm font-bold shrink-0">
            {initial}
          </div>
...
export const AffiliateSidebar = () => {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className="hidden md:flex fixed left-0 top-0 h-full w-56 bg-[#0f0a1e] text-white flex-col z-40">
        <SidebarContent
          pathname={pathname}
          initial={initial}
          user={user}
      ...
      {/* Mobile top bar */}
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 bg-[#0f0a1e] text-white flex items-center justify-between px-4 py-3 border-b border-white/10">
        <div className="flex items-center gap-2">
      ...
      <aside
        className={[
          "md:hidden fixed left-0 top-0 h-full w-64 bg-[#0f0a1e] text-white flex flex-col z-50 transition-transform duration-300",
